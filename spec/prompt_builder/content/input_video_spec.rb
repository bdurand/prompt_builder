...
RSpec.describe PromptBuilder::Content::InputVideo do
  describe "#to_h" do
    it "serializes with a video_url" do
      content = described_class.new(video_url: "https://example.com/video.mp4")
  ...
  describe ".from_h" do
    it "deserializes from a hash" do
      ...
      expect(content.video_url).to eq("https://example.com/video.mp4")
    end

    it "handles missing video_url" do
      content = described_class.from_h({"type" => "input_video"})
      expect(content.video_url).to be_nil
    end
  end

  describe "round-trip" do
    it "round-trips through to_h and from_h" do
      original = described_class.new(video_url: "https://example.com/video.mp4")
  ...
  describe "polymorphic dispatch" do
    it "dispatches from Content::Base.from_h" do
      ...
      expect(content.video_url).to eq("https://example.com/clip.mp4")
    end
  end
end
