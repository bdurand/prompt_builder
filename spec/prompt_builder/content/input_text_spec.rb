...
RSpec.describe PromptBuilder::Content::InputText do
  describe "#to_h" do
    it "serializes to a hash with type and text" do
      content = described_class.new(text: "Hello")
      expect(content.to_h).to eq({"type" => "input_text", "text" => "Hello"})
    end
  end

  describe ".from_h" do
    it "deserializes from a hash" do
      content = described_class.from_h({"type" => "input_text", "text" => "Hello"})
  ...
  describe "polymorphic dispatch" do
    it "dispatches from Content::Base.from_h" do
      content = PromptBuilder::Content::Base.from_h({"type" => "input_text", "text" => "Hello"})
